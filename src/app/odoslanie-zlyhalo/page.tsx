...
type ContactRequestErrorPageProps = {
...
export default async function ContactRequestErrorPage({ searchParams }: ContactRequestErrorPageProps) {
  const params = searchParams ? await searchParams : undefined;
  const message = params?.message || "Nepodarilo sa odoslat dopyt.";
