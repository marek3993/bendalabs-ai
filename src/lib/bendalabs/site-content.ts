...
const auditBotDefaults = {
  sk: {
    ...
    frictionTitle: "Kde sa používatelia pravdepodobne strácajú",
  ...
  cs: {
    ...
    loadingSteps: [
      "Načítám web...",
      "Hledám místa, kde návštěvník ztrácí orientaci...",
    ...
    frictionTitle: "Kde se uživatelé pravděpodobně ztrácejí",
